import type { AliasDeclarationNode } from '../ast/alias-declaration-node.js';
import type { ArrayExpressionNode } from '../ast/array-expression-node.js';
import type { ExportStatementNode } from '../ast/export-statement-node.js';
import type { ExpressionNode } from '../ast/expression-node.js';
import type { ExtendsClauseNode } from '../ast/extends-clause-node.js';
import type { GenericExpressionNode } from '../ast/generic-expression-node.js';
import type { IdentifierNode } from '../ast/identifier-node.js';
import type { ImportClauseNode } from '../ast/import-clause-node.js';
import type { ImportStatementNode } from '../ast/import-statement-node.js';
import type { InferClauseNode } from '../ast/infer-clause-node.js';
import type { InterfaceDeclarationNode } from '../ast/interface-declaration-node.js';
import type { LiteralNode } from '../ast/literal-node.js';
import type { MappedTypeNode } from '../ast/mapped-type-node.js';
import { NodeType } from '../ast/node-type.js';
import type { ObjectExpressionNode } from '../ast/object-expression-node.js';
